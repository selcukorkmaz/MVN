...
#’   mvn_diagnostic_plot(iris[,1:2], type = "qq")  
#’  
#’   # 3D KDE surface with custom view  
#’   ctrl3d <- persp_ctrl(theta = 30, phi = 20)  
#’   mvn_diagnostic_plot(iris[,1:2], type = "persp", default = FALSE, persp_ctrl = ctrl3d)  
#’  
#’   # Contour plot  
#’   mvn_diagnostic_plot(iris[,1:2], type = "contour")  
#’ }  
#’  
...
mvn_diagnostic_plot <- function(data,
                     type = c("qq", "persp", "contour"),
                     default = TRUE,
                     covariance = TRUE, # check
                     ...) {
